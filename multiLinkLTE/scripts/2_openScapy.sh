...
cmds[2]="sshpass -p Drones2018 ssh -tt -X oainuc3@$oainuc3IP sshpass -p Drones2018 ssh -tt -p 3022 -X ubuntu@127.0.0.1 nano scapy_sendPacket.py"
#cmds[3]="sshpass -p Drones2018 ssh -tt -X oainuc3@$oainuc3IP sshpass -p Drones2018 ssh -tt -p 3023 -X ubuntu@127.0.0.1 openconnect https://asa-cluster.lrz.de -u '!ga83pod'"
cmds[4]="sshpass -p Drones2018 ssh -tt -X oainuc3@$oainuc3IP sshpass -p Drones2018 ssh -tt -p 3023 -X ubuntu@127.0.0.1 nano scapy_sendPacket.py"
